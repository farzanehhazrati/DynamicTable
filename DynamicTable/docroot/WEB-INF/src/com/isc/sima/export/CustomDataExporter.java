...
public class CustomDataExporter implements ActionListener, StateHolder {
	...
	public CustomDataExporter(ValueExpression target, ValueExpression type, ValueExpression fileName, ValueExpression pageOnly, ValueExpression selectionOnly, ValueExpression encoding, MethodExpression preProcessor, MethodExpression postProcessor) {
		this.target = target;
		this.type = type;
	...
	public void processAction(ActionEvent event){
		...
		try {
			PDFCustomExporter exporter = CustomExporterFactory.getExporterForType(exportAs);
